...
class GUI:
    ...
    def f_button_clicked(self):
        ...
        # Make frames
        speed_frame = Frame(self.popup, bg="white", width=GUI.POP_WIDTH, height=.25 * GUI.POP_WIDTH, pady=5, padx=3)
    ...
    def main(self):
        ...
        bot_button_frame = Frame(self.window, bg="black", width=.75 * GUI.WIDTH, height=.50 * GUI.HEIGHT, pady=0,
                                 padx=0)
        queue_frame = Frame(self.window, bg="white", width=.25 * GUI.WIDTH, height=.75 * GUI.HEIGHT, pady=0, padx=0)
        ...
        # Make buttons
        f_button = Button(top_button_frame, width=27, height=12, text="FORWARD", bg="white", fg="Black",
                          command=self.f_button_clicked)
        l_button = Button(top_button_frame, width=27, height=12, text="LEFT", bg="white", fg="Black",
                          command=self.l_button_clicked)
        r_button = Button(top_button_frame, width=27, height=12, text="RIGHT", bg="white", fg="Black",
                          command=self.r_button_clicked)
        h_button = Button(bot_button_frame, width=41, height=13, text="HEAD SWIVEL", bg="white", fg="Black",
                          command=self.h_button_clicked)
        w_button = Button(bot_button_frame, width=41, height=13, text="WAIST SWIVEL", bg="white", fg="Black",
        ...
        f_button.grid(row=0, column=0, sticky="nsew")
        l_button.grid(row=0, column=1, sticky="nsew")
        r_button.grid(row=0, column=2, sticky="nsew")
